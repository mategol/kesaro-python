...
def inject_files(command_entry):
...
def start_help_center():
    ...
    execute_button = tk.Button(root, text="Execute", command=lambda: inject_files(command_entry))
    execute_button.pack()
    ...
    # Add Explain button
    explain_button = tk.Button(root, text="Explain", command=explain_injection)
    explain_button.pack()
